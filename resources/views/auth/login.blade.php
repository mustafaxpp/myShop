    ...
    <x-jet-authentication-card>
        ...
        <div class="rounded-t mb-0 px-6 py-6">
            ...
            <div class="btn-wrapper text-center">
                <a href="{{ url('auth/facebook') }}"  class="active:bg-blue-100 hover:bg-blue-300 text-gray-800 font-normal px-4 py-2 rounded outline-none focus:outline-none mr-2 mb-1 uppercase shadow inline-flex items-center font-bold text-xs" type="button" style="transition: all 0.15s ease 0s;"><img alt="..." class="w-5 mr-1" src="https://www.flaticon.com/svg/vstatic/svg/2111/2111393.svg?token=exp=1618450029~hmac=0e2a91090d56f40988b5a7eb9421514c"> Facebook </a>
