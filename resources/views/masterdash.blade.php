    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route("dashboard")}}">
                ...
                <div class="sidebar-brand-text mx-1">Admin {{ __('Dashboard') }}</div>
            </a>
            ...
            <!-- Nav Item - Users -->
            <li class="nav-item {{ Request::is('dashboard/brand') ? 'active' : ''}}">
                <a class="nav-link" href="{{ route('brand') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>{{ __('messages.Brands') }}</span></a>
            </li>

            <!-- Nav Item - Users -->
            <li class="nav-item {{ Request::is('dashboard/stock') ? 'active' : ''}}">
                <a class="nav-link" href="{{ route('stock') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>{{ __('messages.Stocks') }}</span></a>
            </li>
            <!-- Nav Item - Users -->
            <li class="nav-item {{ Request::is('dashboard/product') ? 'active' : ''}}">
                <a class="nav-link" href="{{ route('product') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>{{ __('messages.Products') }}</span></a>
            </li>
            <!-- Nav Item - Users -->
            ...
            <hr class="sidebar-divider d-none d-md-block">
            <!-- Nav Item - Users -->
            <li class="nav-item {{ Request::is('dashboard/supplier') ? 'active' : ''}}">
                <a class="nav-link" href="{{ route('supplier') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>{{ __('messages.Suppliers') }}</span></a>
            </li>
            <li class="nav-item {{ Request::is('dashboard/shipping') ? 'active' : ''}}">
                <a class="nav-link" href="{{ route('shipping') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>{{ __('messages.Shipping') }}</span></a>
            </li>
            <li class="nav-item {{ Request::is('dashboard/payment') ? 'active' : ''}}">
            ...
            <li class="nav-item {{ Request::is('dashboard/order') ? 'active' : ''}}">
                <a class="nav-link" href="{{ route('order') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>{{ __('messages.Orders') }}</span></a>
            </li>
            <!-- Divider -->
            <hr class="sidebar-divider d-none d-md-block">
            <li class="nav-item">
